# Copilot Plan-Checker Hook — Anvi Cognitive Layer

> Adds cognitive dimensions to any plan-review pass run through Copilot
> Chat. These dimensions check reasoning quality, not just plan structure.
...
Load this hook via `.github/copilot-instructions.md`, a review-focused
...
plan-checker agent of its own to attach this to.
