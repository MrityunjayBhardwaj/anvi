...
const DOT_MD = [
  '## H48. "An importer ALLOWLIST silently omits a field" (#192, 2026-06-03)', // 1
  'Root cause: y',            // 2
  '**REF:** emit/layer.ts',   // 3
  '',                         // 4
  '## H49: colon form',       // 5
...
eq(dot[0].id, 'H48', 'period form → id');
eq(dot[0].title, '"An importer ALLOWLIST silently omits a field" (#192, 2026-06-03)',
...
eq(parseEntries('## PV49/PV53 addendum — raw-RHS substitution\nbody').length, 0,
